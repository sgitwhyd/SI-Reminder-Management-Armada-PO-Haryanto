            ...
            <div class="card shadow">
               ...
               <div class="card-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                        <input type="text" class="form-control" id="checker" name="checker" placeholder="petugas checker">
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="date-check" class="col-sm-3 col-form-label">Date Check</label>
                     <div class="col-sm-9">
                        <input type="date" class="form-control" id="date-check" name="date-check" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="time-check" class="col-sm-3 col-form-label">Time Check</label>
                     <div class="col-sm-9">
                        <input type="time" class="form-control" id="time-check"  name="time-check" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="no_polisi" class="col-sm-3 col-form-label">No. Polisi</label>
                     <div class="col-sm-9">
                        <input type="text" class="form-control" id="no_polisi" name="no_polisi" placeholder="nomor polisi" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="no_lambung" class="col-sm-3 col-form-label">No. Lambung</label>
                     <div class="col-sm-9">
                        <input type="text" class="form-control" id="no_lambung" name="no_lambung" placeholder="nomor lambung" required>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="card shadow">
               ...
               <div class="card-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                        <input type="text" class="form-control" id="posisi_kilometer" name="posisi_kilometer" placeholder="kilometer sekarang" required>
                     </div>
                  </div>
                  <div class="form-group row">
                     <label for="posisi_bbm" class="col-sm-3 col-form-label">Posisi BBM</label>
                     <div class="col-sm-9">
                        <input type="text" class="form-control" id="posisi_bbm" name="posisi_bbm" placeholder="BBM sekarang" required>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="card shadow">
               ...
               <div class="card-body">
                  <div class="form-group mb-3">
                     ...
                     <textarea class="form-control" id="catatan-rampcheck" placeholder="Catatan dalam pengecekan" rows="3"></textarea>
                  </div>
