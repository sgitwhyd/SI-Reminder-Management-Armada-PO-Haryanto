...
CREATE TABLE `users` (
  ...
  `verify_key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
insert  into `users`(`id_user`,`username`,`password`,`role`,`email`,`verify_key`,`is_active`,`created_at`,`updated_at`) values 
